...
const Program = ({progDetails, middle, activeBtn}) => {
    ...
    return (
        ...
        <Link href={'/'}
            className={`flex flex-col ${activeBtn? ' min-h-[20rem] ' : ' md:min-h-[32rem] min-h-[34rem] '} 
            items-start ${middle? ' programBg ' : ' bg-[#281140] '}
                            p-3 gap-2 text-white max-w-[21rem]  md:w-80 rounded-md`}>
            <header>
